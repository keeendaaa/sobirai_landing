...
import heroVideoMp4 from '../assets/0131-1.mp4'
...
function App() {
  ...
  return (
    <div className="App" ref={appRef}>
          ...
          <div className="container">
            <div className="hero-content">
              <div className="hero-subtitle">
                <p><span className="gradient-text">3D</span>-модель и проектная документация за один клик</p>
              </div>
      ...
      <MacbookScrollDemo src={model3dImage} />
        ...
        <div className="container">
          ...
          <div className="footer-links">
            ...
            <div className="footer-column">
              ...
              <p>
                <a href="mailto:business@sobirai.tech">business@sobirai.tech</a>
              </p>
              <p>
                <a href="https://t.me/skkAteAndDestTtroy" target="_blank" rel="noreferrer">
                  tg: @skkAteAndDestTtroy
                </a>
              </p>
            </div>
          </div>
